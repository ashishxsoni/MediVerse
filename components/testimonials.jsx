...
//             <Card
//               key={index}
//               className="border-emerald-900/20 hover:border-emerald-800/40 transition-all duration-300 hover:scale-110 hover:shadow-3xl hover:shadow-emerald-900/25 group cursor-pointer"
//             >
//               <CardContent className="pt-6">
//                 <div className="flex items-center mb-4">
//                   <div className="w-12 h-12 rounded-full bg-emerald-900/20 flex items-center justify-center mr-4 group-hover:bg-emerald-800/30 group-hover:scale-110 transition-all duration-300">
